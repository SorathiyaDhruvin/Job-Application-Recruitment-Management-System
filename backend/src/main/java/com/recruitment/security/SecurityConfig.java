...
public class SecurityConfig {
    ...
    @Value("${app.cors.allowed-origins:http://localhost:5173,http://localhost:3000,https://job-application-recruitment-managem.vercel.app}")
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Job modifications (recruiter or admin)
